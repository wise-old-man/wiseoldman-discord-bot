...
![Group Members Left](./assets/group:members_left.png)
![Group Member Joined](./assets/group:member_joined.png)
...
![New Member Achievement](./assets/group:member_achievement.png)
...
![Member HCIM Died](./assets/group:hcim_died.png)
