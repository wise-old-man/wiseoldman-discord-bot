...
Besides commands, this bot also can send [notifications](/notifications) to your Discord when something happens to one of your group members (new achievements, HCIM death, etc), or to your competitions (started, ended, starting soon, etc).
...
![Config Notifications Command (default)](./assets/config:notifications:default.png)
...
![Config Notifications Command (default)](./assets/config:notifications:members.png)
...
![Config Notifications Command (default)](./assets/config:notifications:disable.png)
...
![Player Stats Command](./assets/stats:levels:zezima.png)
...
![Player Stats Command](./assets/stats:experience.png)
...
![Player Bosses Command](./assets/bosses:killcounts:zezima.png)
...
![Player Bosses Command](./assets/bosses:ehb.png)
...
![Player Activities Command](./assets/activities:scores:zezima.png)
...
![Player Activities Command](./assets/activities:ranks.png)
...
![Player Gained Command](./assets/gained:year.png)
...
![Player Gained Command](./assets/gained:month:rro.png)
