...
:::info
To configure this notification, you can use the "Members Joined" notification type in the `/config notifications` command.
:::

<br />

![Group Member Joined](./assets/group_members_joined.png)
...
:::info
To configure this notification, you can use the "Members Left" notification type in the `/config notifications` command.
:::

<br />

![Group Member Joined](./assets/group_members_left.png)
...
:::info
To configure this notification, you can use the "Members Roles Changed" notification type in the `/config notifications` command.
:::

<br />

![Group Member Joined](./assets/members_role_changed.png)
